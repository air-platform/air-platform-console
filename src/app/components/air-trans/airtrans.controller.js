...
(function () {
    ...
    angular
        .module('iot')
        .controller('AirtransController', AirtransController);

    /** @ngInject */
    function AirtransController(NetworkService,StorageService, constdata,$state,$rootScope, $uibModal,$log,toastr,i18n, delmodaltip) {
