...
(function () {
    ...
    angular
        .module('iot')
        .controller('VenueInfoController', VenueInfoController);

    /** @ngInject */
    function VenueInfoController(NetworkService,StorageService, constdata,$state,$rootScope, $uibModal,$log,toastr,i18n, delmodaltip) {
