...
(function () {
    ...
    angular
        .module('iot')
        .controller('VenueInfoEditController', VenueInfoEditController)
    ...
    /** @ngInject */
    function VenueInfoEditController($scope, NetworkService,StorageService,constdata,i18n,$rootScope,$stateParams,toastr) {
        ...
        vm.uploadFile = function (){
            ...
            NetworkService.postForm(constdata.api.uploadFile.qiniuPath,vm.myUploadFile,function (response) {
                ...
                vm.user.picture = response.data.url;
                //vm.backAction();
            },function (response) {
                vm.showSpinner = false;
        ...
        function getTemplateItem() {
            ...
            NetworkService.get(vm.reqPath + '/venue-templates',null,function (response) {

                vm.templates = response.data.content;
