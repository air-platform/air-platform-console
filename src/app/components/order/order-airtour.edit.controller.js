...
(function () {
    ...
    angular
        .module('iot')
        .controller('OrderAirtourEditController', OrderAirtourEditController)
    ...
    /** @ngInject */
    function OrderAirtourEditController($scope, NetworkService,StorageService,constdata,i18n,$rootScope,$stateParams,toastr) {
