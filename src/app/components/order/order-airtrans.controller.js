...
(function () {
    ...
    angular
        .module('iot')
        .controller('OrderAirtransController', OrderAirtransController);

    /** @ngInject */
    function OrderAirtransController(NetworkService,StorageService, constdata,$state,$rootScope, $uibModal,$log,toastr,i18n, delmodaltip) {
