...
(function () {
    ...
    angular
        .module('iot')
        .controller('OrderAirjetEditController', OrderAirjetEditController)
    ...
    /** @ngInject */
    function OrderAirjetEditController($scope, NetworkService,StorageService,constdata,i18n,$rootScope,$stateParams,toastr) {
