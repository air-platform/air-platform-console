...
(function () {
    ...
    angular
        .module('iot')
        .controller('OrderClassEditController', OrderClassEditController)
    ...
    /** @ngInject */
    function OrderClassEditController($scope, NetworkService,StorageService,constdata,i18n,$rootScope,$stateParams,toastr) {
