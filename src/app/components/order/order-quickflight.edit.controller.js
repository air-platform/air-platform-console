...
(function () {
    ...
    angular
        .module('iot')
        .controller('OrderQuickflightEditController', OrderQuickflightEditController)
    ...
    /** @ngInject */
    function OrderQuickflightEditController($scope, NetworkService,StorageService,constdata,i18n,$rootScope,$stateParams,toastr) {
