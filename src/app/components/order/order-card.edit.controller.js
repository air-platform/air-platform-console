...
(function () {
    ...
    angular
        .module('iot')
        .controller('OrderCardEditController', OrderCardEditController)
    ...
    /** @ngInject */
    function OrderCardEditController($scope, NetworkService,StorageService,constdata,i18n,$rootScope,$stateParams,toastr) {
