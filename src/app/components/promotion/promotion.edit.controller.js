...
(function () {
    ...
    angular
        .module('iot')
        .controller('PromotionEditController', PromotionEditController)
    ...
    /** @ngInject */
    function PromotionEditController($scope, NetworkService,StorageService,constdata,i18n,$rootScope,$stateParams,toastr) {
