...
(function () {
    ...
    angular.module('iot').controller('SdkEditConfigurationCtrl', SdkEditConfigurationCtrl);
    /** @ngInject */
    function SdkEditConfigurationCtrl($scope, $uibModal,logger, $log, $state, $stateParams,StorageService, NetworkService, constdata, toastr,UserInfoServer) {
        ...
        //var canvas = new draw2d.Canvas("gfx_holder_config");
        var figure1 = null;
       ...
       // canvas.installEditPolicy(Draw2dConnection);
        ...
        /*vm.saveConData = function() {
            ...
            if(schemaData&&schemaData.isValid) {
                ...
                var submitData = function() {
                    NetworkService.put(constdata.api.product.configUpdatePath+'/'+argsProduct.name+'/profiles/v'+argsSdk.version+'/schemas/configuration',savedData,function (response) {  
        ...
        function getProData() {
            NetworkService.get(constdata.api.product.configInfoPath+'/'+argsProduct.name+'/profiles/v'+argsSdk.version+'/schemas/configuration',null,function (response) {
                //监听数据变化
      ...
      //  }
        ...
        */
        ...
        $.ajax({
            url:BASE_API_URL+constdata.api.product.configInfoPath+'/'+argsProduct.name+'/profiles/v'+argsSdk.version+'/schemas/configuration',
            type: 'GET',
