...
(function () {
    ...
    angular.module('iot').controller('SdkEditDataCtrl', SdkEditDataCtrl);

    /** @ngInject */
    function SdkEditDataCtrl($scope, $uibModal,logger, $log, $state, $stateParams,StorageService, NetworkService, constdata, toastr,UserInfoServer) {
       ...
       // var canvas = new draw2d.Canvas("gfx_holder_data");
        var figure1 = null;
      ...
      //  canvas.uninstallEditPolicy(new draw2d.policy.canvas.DefaultKeyboardPolicy());
       ...
       /* vm.saveData = function() {
            ...
            if(schemaData&&schemaData.isValid) {
                ...
                var submitData = function() {
                    NetworkService.put(constdata.api.product.dataUpdatePath+'/'+argsProduct.name+'/profiles/v'+argsSdk.version+'/schemas/data',savedData,function (response) {  
        ...
        function getProData() {
            NetworkService.get(constdata.api.product.dataInfoPath+'/'+argsProduct.name+'/profiles/v'+argsSdk.version+'/schemas/data',null,function (response) {
                //监听数据变化
        ...
        */
        ...
        $.ajax({
            url:BASE_API_URL+constdata.api.product.dataInfoPath+'/'+argsProduct.name+'/profiles/v'+argsSdk.version+'/schemas/data',
            type: 'GET',
