...
(function () {
    ...
    angular
        .module('iot')
        .controller('AirjetBookController', AirjetBookController);

    /** @ngInject */
    function AirjetBookController(NetworkService,StorageService, constdata,$state,$rootScope, $uibModal,$log,toastr,i18n, delmodaltip) {
        ...
        function goDetail(item) {
            $state.go('app.editairjetbook',{username:item.id, args:{type:'detail'}});
        ...
        function removeItem(item) {
            ...
            NetworkService.delete(vm.reqPath + '/fleets/'+ item.id,null,function success() {
