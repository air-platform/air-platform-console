        ...
        .constant('constdata', {
           ...
           //apiHost_DEV:'http://localhost:9005',
            ...
            api:{ "token":{"refresh":"/iot/api/v1/account/token/refresh"},
                ...
                "order":
                {"airtaxi":"/api/v1/tenant/airtaxi/orders","airtour":"/api/v1/tenant/airtour/orders","airtrans":"/api/v1/tenant/airtransport/orders","airbook":"/api/v1/tenant/charter/orders","airflight":"/api/v1/tenant/ferryflight/orders","card":"/api/v1/tenant/jetcard/orders","course":"/api/v1/tenant/airtaxi/orders"},
                "course":
